...
public class BoardController {
   ...
   private final String filePath = "C:\\git\\workspace_spring\\demo0921\\src\\main\\webapp\\pds"; // 파일이 저장될 위치
   //////////////////////////[@ResponseBody 시작]///////////////////////
   @ResponseBody
   ...
   public String boardDetail(Model model, @RequestParam Map<String,Object> pMap) {
      logger.info("boardDetail 호출 성공");//cb_serch
...
//         String filename = HangulConversion.toUTF(bs_file.getOriginalFilename());
         ...
         String savePath = "C:\\git\\workspace_spring\\demo0921\\src\\main\\webapp\\pds";
         //파일에 대한 풀 네임 담기
